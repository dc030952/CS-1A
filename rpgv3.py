...
def defencedice():
  ...
  Ddiceroll = str(adiceroll1)
  print("You rolled ", Ddiceroll, "for your attack.")
  defencedice = ddiceroll
  ...
  while (Stairs == False):
    ...
    if(direction == "W"):
      ...
      if len(firstfloorN) == 0:
        ...
        HP = str(Health)  
        print("An orc jumps you from the shadows and takes " + HP +  " health.")
        time.sleep(2)
          ...
          if "Rouge" in party:
            if "Rouge Dagger" in inventory:
              ...
              if rougea == 1: 
                ...
                print("You roll for your attack...")
                time.sleep(1)
                Adiceroll1 = str(adiceroll1)
                print("You rolled", Adiceroll1, "for your attack.")
              if adiceroll1 ==                 
        time.sleep(1.5)
        ...
        print("A party of orcs appear in the room you are in.")
        time.sleep(1.5)  #Combat
